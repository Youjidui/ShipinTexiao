...
BEGIN_MESSAGE_MAP(CTestClientApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CTestClientApp::OnAppAbout)
	// 基于文件的标准文档命令
...
BOOL CTestClientApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CTestClientDoc),
		RUNTIME_CLASS(CMainFrame),       // 主 SDI 框架窗口
		RUNTIME_CLASS(CTestClientView));
	if (!pDocTemplate)
		return FALSE;
...
// 用于运行对话框的应用程序命令
void CTestClientApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CTestClientApp 自定义加载/保存方法

void CTestClientApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CTestClientApp::LoadCustomState()
{
}

void CTestClientApp::SaveCustomState()
{
}

// CTestClientApp 消息处理程序
